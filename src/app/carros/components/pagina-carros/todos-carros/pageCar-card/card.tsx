...
import { CarButton } from "@/feature/cars/components/button-card/buttonCars";
...
export function CardPageTwo({
  ...
  return (
    <div>
      <div>
        <CardIMG image={image} detail={`${brand} ${model}`} />
      </div>
      ...
      <div className="bg-white rounded-2xl text-center">
        ...
        <div className="p-5">
          ...
          <p className="text-gray-600 pt-5">{plan}</p>
        </div>
